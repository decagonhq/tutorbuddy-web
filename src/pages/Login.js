                ...
                <div className="md:w-[60%] px-4 mx-auto">
                    ...
                    <div className="bg-white mt-5 md:mt-10 py-6 md:py-16">
                        <form className="md:w-2/4 px-6 mx-auto text-sm">
                            ...
                            <Link className="text-[#17A1FA]" to="/forgot-password">Forgot password?</Link>
                            <button className="text-sm block bg-pry w-full py-3 text-white mt-6">Login</button>
                        </form>
                        <div className="text-center mt-10">Don’t have an account? <Link to="/student/signup" className="text-pry">Create Account</Link></div>
                    </div>
                </div>
            </div>
        </div>
